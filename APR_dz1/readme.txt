...
The window with your file explorer opens. You find "0036493088" folder, then open "APR_dz1" where you will find "APR_dz1.sln" solution which you will open.
...
You can find text files with matrices for every task if you position yourself in a folder where "APR_dz1.sln" is and from there you go to APR_dz1 -> matrice.