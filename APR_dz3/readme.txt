...
The window with your file explorer opens. You find "0036493088" folder, then open "APR_dz3" where you will find "APR_dz3.sln" solution which you will open.
...
You can find text files with matrices for every task if you position yourself in a folder where "APR_dz3.sln" is and from there you go to APR_dz3 -> matrice.