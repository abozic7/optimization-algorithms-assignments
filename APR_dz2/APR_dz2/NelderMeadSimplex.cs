...
namespace APR_dz2
{
    public class NelderMeadSimplex
    {
        ...
        /// <param name="function">Function used in algorithm.</param>
        /// <param name="e">Precision.</param>
        /// <returns>Returns false if criteria is not satisfied, otherwise returns true.</returns>

        public static bool IsTerminationCriteriaSatisfied(List<double[]> simplexPoints, double[] centroid, Function function, double e)
        {
            double sum = 0;
